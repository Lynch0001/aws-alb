...
for_each = { for k, v in var.additional_target_group_attachments : k => v if local.create_lb }

target_group_arn  = aws_lb_target_group.main[each.value.target_group_index].arn
target_id         = each.value.target_id
